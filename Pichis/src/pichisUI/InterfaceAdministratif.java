...
//        champAnneeEntree.setText("" + Calendar.getInstance().get(Calendar.YEAR));
    ...
    private void initComponents() {
        ...
        int height = (int) 0.4*this.height;
        int width  = (int) 0.7*this.width;
        ongletSejour.setPreferredSize(new java.awt.Dimension(width, height));
        ...
        ongletSejourLayout.setVerticalGroup(
            ...
            .addGroup(ongletSejourLayout.createSequentialGroup()
                .addGap(26, 26, 26)
                .addComponent(jScrollSejours, javax.swing.GroupLayout.PREFERRED_SIZE, 409, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
