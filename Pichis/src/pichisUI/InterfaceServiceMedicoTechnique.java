        ...
        if (jTextPaneAjoutResultat.isEditable()) {
            if (jTextPaneAjoutResultat.getText().isEmpty()) {
                ...
                if (reply == 0) {
                    ...
                    jTextPaneAjoutResultat.setEditable(false);
                    jTextPaneAjoutResultat.setBackground(new java.awt.Color(51, 255, 0));
                }
            }
        } else {
